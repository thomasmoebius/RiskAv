...
*********************************  ELECTRICITY  MODEL  *************************
    ...
    POSITIVE VARIABLES
        ...
        CAP_new(i,n,year)                investment in generation capacity
...
SHED_max(sector,n,t,scen,year)            maximum load shedding per country
storagelevel(t,i,n,year,scen)             storage level at time t
storagelevel_max(t,i,n,year,scen)         max level of reservoir (upper basin)

reservoir_max_gen(i,n,t,year,scen)          maximum hourly generation of hydro reservoirs
reservoir_year_cap(i,n,year,scen,month)     monthly water budget of a hydro reservoir

Res_lineflow_1(n,nn,t,year,scen)            electricity flow is limited to NTCs
...
res_cvar_1                  contidional value at risk 1
res_cvar_2                  contidional value at risk 2

PSP_new_max                 maximum isnvestments in PSPs
;
...
%Store_invest%                                          + CAP_new(stort,n,year)*cpf
;
...
%Store_invest%                                                      + CAP_new(stort,n,year)*af(stort,n)
;

PSP_new_max(stort,n,year)..                            CAP_new(stort,n,year) =L= cap_max(stort,n)
;
...
;
reservoir_year_cap(ReservT,n,year,scen,Month)$cap_existing(ReservT,n,year,scen)..
                         sum(t$Month_T(Month,t), G(ReservT,n,t,year,scen)) =L= cap_existing(ReservT,n,year,scen) * RHS * budget_reservoir_upload(month,n)
;

***********       Network defintions and restrictions       ********************

Res_lineflow_1(n,nn,t,year,scen)..
                        FLOW(n,nn,t,year,scen) =L=  ntc(n,year,nn)
